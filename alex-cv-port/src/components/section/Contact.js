        ...
        <div className="parallax">
            ...
            <div className="git-cont row">
                <div className="col-12 col-sm-6 half">
                    <form method="POST" action="https://formspree.io/f/xayabqzd">
                ...
                <div className="d-flex justify-content-center align-items-center flex-column mt-0 mt-md-5">
                  <div className="inline-block">
                    ...
                    {social.facebook && <a title="Visit Facebok profile" target="_blank" rel="noopener noreferrer" target="_blank" href={social.facebook}><i className="fab fa-facebook"></i></a>}
                    {social.instagram && <a title="Visit Instagram profile" target="_blank" rel="noopener noreferrer" target="_blank" href={social.instagram}><i className="fab fa-instagram"></i></a>}
                  </div>
